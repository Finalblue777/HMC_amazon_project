...
def main(
    ...
    while cntr < max_iter and error > tol:
        if two_param_uncertainty == False:
            ...
            ws = GamsWorkspace(system_directory=r"/project/lhansen/hmc/Gams/gams43.4_linux_x64_64_sfx", working_directory=cwd)
        ...
        # Update gamma value
        weight     =  weight  # <-- Not sure how this linear combination weighting helps!
        if mode_as_solution:
        ...
        pickle.dump(results, open(outputdir+'results.pcl', 'wb'))
